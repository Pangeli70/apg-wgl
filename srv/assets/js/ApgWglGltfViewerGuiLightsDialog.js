export class ApgWglGltfViewerGuiLightsDialog {
  ...
  closeLightsDialogButton;
  constructor(aviewer) {
    this._viewer = aviewer;
    const document = this._viewer.document;
    this.me = document.getElementById("lightsSettingsDialog");
    this.parent = document.getElementById("settingsDialog");
    ...
    this.closeLightsDialogButton = document.getElementById("closeLightsDialogButton");
    this.closeLightsDialogButton.addEventListener("click", (_e) => {
      this.me.close();
    });
