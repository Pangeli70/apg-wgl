...
export class ApgWglProfileHelper {
  ...
  private static _getRandomized3DNodesAlongYAxis(
    anodes = 10,
    asegmentLength = 50,
    axzRange = 10
  ) {
  ...
  private static _getRandomizedStarShapeNodes(aedges: number, aradious = 100) {
  ...
  public static getRandomizedXYPolyline(
    anodes = 10,
    asegmentLength = 50,
    amaxAngleDeg = 30
  ) {
